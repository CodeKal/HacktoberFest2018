...
print("I love CodeKAL") #codekala olan sevgimizi belirtiyoruz
print("I am very happy to be a part of CodeKAL") #codekalın bir parçası olmamızın bizi mutlu ettiğini belirtiyoruz 
